...
public class Function_03_Test {
   ...
   /* BinaryOperator<Person> makeAChild = new BinaryOperator<Person>(){
		...
		@Override
		public Person apply(Person p, Person m) {
			// TODO Auto-generated method stub
			return new Person(p.getFirstname()+"_"+m.getFirstname(),p.getLastname(),0,null);
		}
    	
    };*/
	BinaryOperator<Person> makeAChild = (Person p, Person m) -> new Person(p.getFirstname()+" "+m.getFirstname(),p.getLastname(),0,null);
    //  end::makeAChild[]
